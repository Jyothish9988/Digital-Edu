...
$smartyObj->display('tr_std_attendance.tpl');
$smartyObj->display('teacher_footer.tpl');

}
elseif($time5>=strtotime("12:30:00") AND $time5<=strtotime("13:29:59"))
	{
		echo"<script>alert('lunch break');window.location.href='attendance_subject_select.php?sem=$sem&&subject=$subject';</script>";
}
else{
	echo"<script>alert('OFF TIME');window.location.href='attendance_subject_select.php?sem=$sem&&subject=$subject';</script>";
}
