<?php /* Smarty version 2.6.26, created on 2023-05-15 07:00:25
         compiled from add_teacher.tpl */ ?>
<head>
	<?php echo '
<script>    
...
<table>
        ...
        <!-- adno,name,photo,address,pin,dob,sex,religion,caste,fname,fjob,fpno,mname,mjob,mpno,course,spno,aadhar,dep,ten,tencer,plustwo,plustwocer,doj,grad,email -->
				...
				<tr><td>DOB</td><td><input type="date" name="dob"  class="form-control" id="t5" max="<?php echo $this->_tpl_vars['prevdate']; ?>
"></td></tr>
