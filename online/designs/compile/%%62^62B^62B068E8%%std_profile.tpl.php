<?php /* Smarty version 2.6.26, created on 2023-05-18 06:11:33
         compiled from std_profile.tpl */ ?>
 <!--
Author: W3layouts
...
"></li>
  ...
  <li>
    <ul class="address-text">
        <li>Address</li>
        <li><textarea name="address" class="form-control" id="t3" ><?php echo $this->_tpl_vars['j']['address']; ?>
</textarea></li>
    </ul>
  </li>
