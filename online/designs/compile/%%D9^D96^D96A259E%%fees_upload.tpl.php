<?php /* Smarty version 2.6.26, created on 2023-05-16 18:07:26
         compiled from fees_upload.tpl */ ?>
<br>
<br>
<br>
<br>
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="fees" placeholder="Enter Fee Amount..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
