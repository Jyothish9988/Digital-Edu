<?php /* Smarty version 2.6.26, created on 2023-05-12 20:36:13
         compiled from student_sub_header.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<?php echo '
  <head>
...
<!--   <div class="sub-header">
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li ><a href="std_tr_chat.php">Chat</a></li>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
<h6>Welcome to the College Department Portal!</h6>
<h2>Explore Your Academic Resources Here</h2>
        </div>
      </div>
    </div>
  </section>
