<?php /* Smarty version 2.6.26, created on 2023-05-13 18:32:25
         compiled from addon_edit.tpl */ ?>
<?php echo '
<script>    
        function ver()
  {
...
?>     
                                    ...
                                    <input type="hidden" name="hide" value="h">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="t1" name="title" value="<?php echo $this->_tpl_vars['j']['course']; ?>
"placeholder="Enter COURSE NAME ..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea name="details" class="form-control" id="t2" placeholder="Enter COURSE DETAILS.." ><?php echo $this->_tpl_vars['j']['details']; ?>
</textarea>
...
" heigh="150px" width="150px" placeholder="PLEASE REUPLOAD IMAGE">
                                        <!-- </div>
                                            <div class="col-lg-6"> -->
