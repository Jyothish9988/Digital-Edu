<?php /* Smarty version 2.6.26, created on 2023-05-15 06:45:12
         compiled from std_tr_chat_l.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div id="app" class="app">
    ...
    <section id="main-left" class="main-left">
      ...
      <div id="chat-list" class="chat-list">
                                            ...
                                            <!-- --------------------------------GROUP chat------------------------------ -->
              <?php if ($this->_tpl_vars['sem'] != null): ?>
  ...
  <?php endif; ?>
    <!-- --------------------------------------------------------------group chat------------------------------------------------ -->
        ...
        <div id="friends" class="friends">
          ...
          <a href="std_hod_chat2.php?sem=<?php echo $this->_tpl_vars['sem']; ?>
"><div class="friends-credent">
            <!-- name -->
