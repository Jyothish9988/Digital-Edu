<?php /* Smarty version 2.6.26, created on 2023-05-12 20:07:47
         compiled from teacher_main_header.tpl */ ?>
<!--
    Author: W3layouts
...
<title>Teacher Home</title>
    ...
    <!-- //css files -->
    <link href="teacher/css/easy-responsive-tabs.css" rel=\'stylesheet\' type=\'text/css\'/>
    <link rel="stylesheet" href="teacher/css/jquery-ui.css" /><!-- Calendar -->
    <!-- testimonials css -->
    <link rel="stylesheet" href="teacher/css/flexslider.css" type="text/css" media="screen" property="" /><!-- flexslider css -->
    <!-- //testimonials css -->
    <!-- web-fonts -->
    ...
    <div class="top-nav">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand text-uppercase" href="#">Digital EDU</a>
                ...
                <div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="notice_tr.php">Notice Board</a>
                        </li>
                     <!--    <li class="nav-item">
                            <a class="nav-link" href="tr_chat.php">Chat</a>
                        </li> -->
                     <!--    <li class="nav-item">
                    ...
                    <div class="dot">
                        <div class="container">
                            <div class="slider_banner_info_w3ls">
                                <h1 class="text-uppercase mb-3">Welcome to the college portal</h1>
                                <p>As a teacher, you have access to all the college resources and are able to keep track of your students\' progress. With this portal, you can also check attendance, grades, and other reports related to the college.</p>

                                <a href="single.html" class="read" data-toggle="modal" data-target="#exampleModalCenter" role="button">Start exploring </a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li>
                <div class="slider-img2">
                    <div class="dot">
                        <div class="container">
                            <div class="slider_banner_info_w3ls">
                                <h4 class="text-uppercase mb-3">Use the college portal to keep students engaged</h4>
                                <p>The college portal allows you to keep in touch with your students and keep them engaged in their studies. You can assign tasks, give feedback, and provide support when needed.</p>
            ...
            <li>
                <div class="slider-img3">
                    <div class="dot">
                        <div class="container">
                            <div class="slider_banner_info_w3ls">
                                <h4 class="text-uppercase mb-3">Stay connected with your students</h4>
                                <p>The college portal also allows you to stay connected with your students. You can send messages, share resources, and start discussions with your students to keep them engaged and help them learn.</p>
            ...
            <li>
                <div class="slider-img4">
                    <div class="dot">
                        <div class="container">
                            <div class="slider_banner_info_w3ls">
                                <h4 class="text-uppercase mb-3">Access all college resources at once</h4>
                                <p>The college portal allows you to access all college resources in one place. You can access syllabi, course materials, and other important documents quickly and easily. </p>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=1"><img src="student/assets/images/meeting-01.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      ...
                      <a href="tr_header.php?sem=1"><h4>Semester I</h4></a>
                      <p>Novice Level<br><a href="tr_header.php?sem=1" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all imp">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=2"><img src="student/assets/images/meeting-02.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="tr_header.php?sem=2"><h4>Semester II</h4></a>
                      <p>Advanced Beginner Level<br><a href="tr_header.php?sem=2" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=3"><img src="student/assets/images/meeting-03.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="tr_header.php?sem=3"><h4>Semester III</h4></a>
                      <p>Competent Level<br><a href="tr_header.php?sem=3" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all att">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=4"><img src="student/assets/images/meeting-04.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      ...
                      <p>Proficient Level<br><a href="tr_header.php?sem=4" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all att">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=5"><img src="student/assets/images/meeting-03.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      ...
                      <p>Expert Level<br><a href="tr_header.php?sem=5" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all imp">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="tr_header.php?sem=6"><img src="student/assets/images/meeting-02.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                       <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      ...
                      <p> Skill enhancement level<br><a href="tr_header.php?sem=6" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <!-- <div class="agileits_w3layouts-footer-bottom">
         ...
         --><div class="agileits_w3layouts-copyright text-center">
            <p>© 2022 Digital EDU. All Rights Reserved
            </p>
        </div>
    </div>
</section>
