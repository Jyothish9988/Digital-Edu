<?php /* Smarty version 2.6.26, created on 2023-05-12 20:29:26
         compiled from tr_profile.tpl */ ?>
 <!--
Author: W3layouts
...
<ul class="address">
  <li>
    <ul class="address-text">
      <li>Teacher"s Id</li>
      <li><input type="text" name="trid" id="t1" class="form-control" value="<?php echo $this->_tpl_vars['j']['trid']; ?>
" readonly></li>
    </ul>
  </li>
  ...
  <li>
    <ul class="address-text">
      <li>First name</li>
      <li><input type="text" name="name1" id="t1" class="form-control" value="<?php echo $this->_tpl_vars['j']['name1']; ?>
" readonly></li>
    </ul>
  </li>
  ...
  <li>
    <ul class="address-text">
      <li>Last name</li>
      <li><input type="text" name="name2" id="t1" class="form-control" value="<?php echo $this->_tpl_vars['j']['name2']; ?>
" readonly></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>Address</li>
      <li><input type="text" name="address" class="form-control" id="t5" value="<?php echo $this->_tpl_vars['j']['address']; ?>
"></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>Pin</li>
      <li><input type="text" name="pin" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['pin']; ?>
"></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>DOB</li>
      <li><input type="date" name="dob" id="t1" class="form-control" value="<?php echo $this->_tpl_vars['j']['dob']; ?>
"></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>SEX</li>
      <li><input type="text" name="sex" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['sex']; ?>
"></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>Qualification</li>
      <li><input type="text" name="quan" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['quan']; ?>
"></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>Contact</li>
      <li><input type="text" name="tpno" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['tpno']; ?>
" readonly></li>
    </ul>
  </li>
 ...
 <li>
    <ul class="address-text">
      <li>Aadhar No</li>
      <li><input type="text" name="adharno" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['adharno']; ?>
" readonly></li>
    </ul>
  </li>
  ...
  <li>
    <ul class="address-text">
      <li>Email</li>
      <li><input type="text" name="email" class="form-control" id="t13" value="<?php echo $this->_tpl_vars['j']['email']; ?>
" ></li>
    </ul>
  </li>
