<?php /* Smarty version 2.6.26, created on 2023-05-12 21:10:16
         compiled from hod_main_header.tpl */ ?>
<!--
Author: W3layouts
                            ...
                            <ul class="menu">
                                ...
                                <!-- <li>
                                    ...
                                    <ul class="inner-dropdown">
                                        <li><a href="hod_students_view.php">UG Students</a></li>
                                        <li><a href="hod_fee_paid_view.php">Fee List</a></li>
                                ...
                                <li>
                                    ...
                                    <input type="checkbox" id="drop-2" />
                                    <ul class="inner-dropdown">
                                        <li><a href="hod_newly_enrolled_std.php"> New Admission</a></li>
                                ...
                                <li>
                                    <!-- First Tier Drop Down -->
                                    <label for="drop-2" class="toggle">Dropdown <span class="fa fa-angle-down" aria-hidden="true"></span> </label>
                                    <a href="#">Teachers<span class="fa fa-angle-down" aria-hidden="true"></span></a>
                                    <input type="checkbox" id="drop-2" />
                                    <ul class="inner-dropdown">
                                ...
                                <li>
                                    ...
                                    <ul class="inner-dropdown">
                                        ...
                                        <!-- <li><a href="groupchat.php?sem={$sem}">GROUPCHAT</a></li> -->
...
<div class="w3-head-all mb-3">
  ...
  <section class="meetings-page" id="meetings">
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=1"><img src="student/assets/images/meeting-01.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="hod_header.php?sem=1"><h4>Semester I</h4></a>
                      <p>Novice Level<br><a href="hod_header.php?sem=1" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=2"><img src="student/assets/images/meeting-02.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                       <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="hod_header.php?sem=1"><h4>Semester II</h4></a>
                      <p>Advanced Beginner Level<br><a href="hod_header.php?sem=2" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=3"><img src="student/assets/images/meeting-03.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="hod_header.php?sem=1"><h4>Semester III</h4></a>
                      <p>Competent Level<br><a href="hod_header.php?sem=3" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all att">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=4"><img src="student/assets/images/meeting-04.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      ...
                      <p>Proficient Level<br><a href="hod_header.php?sem=4" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=5"><img src="student/assets/images/meeting-03.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="hod_header.php?sem=1"><h4>Semester V</h4></a>
                      <p>Expert Level<br><a href="hod_header.php?sem=5" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="hod_header.php?sem=6"><img src="student/assets/images/meeting-02.jpg" alt=""></a>
                    </div>
                    <div class="down-content">
                      <div class="date">
                        <a href="#"><img src="images/ioc.jpg" width="50px" height="50px"></a>
                      </div>
                      <a href="hod_header.php?sem=1"><h4>Semester VI</h4></a>
                      <p>Skill enhancement level<br><a href="hod_header.php?sem=6" class="btn btn-info submit">Select</a></p>
                    </div>
                  </div>
                </div>
    ...
    <div class="copy-right">
        <div class="container">
            <div class="row">
                <p class="copy-right-grids text-md-left text-center my-sm-4 my-4 col-md-6">© 2022 Digital EDU. All Rights Reserved
                </p>
