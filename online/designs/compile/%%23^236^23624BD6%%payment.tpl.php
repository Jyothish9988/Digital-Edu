<?php /* Smarty version 2.6.26, created on 2023-05-16 03:38:05
...
<body>
	...
	<div class="agileinfo_main_grid_left_grid">
					...
					<ul>
						<li>SEMESTER</li>
						<li><?php echo $this->_tpl_vars['asem']; ?>
</li>
					</ul>
					<br>
...
?>
				<div class="agile_amount">
					...
					<h3>Total Price</h3>
					<h4>₹<?php echo $this->_tpl_vars['j']['fee']; ?>
</h4>
    ...
    foreach ($_from as $this->_tpl_vars['j']):
?>
									<input type="hidden" name="fee" value="<?php echo $this->_tpl_vars['j']['fee']; ?>
">
									<?php endforeach; endif; unset($_from); ?>
