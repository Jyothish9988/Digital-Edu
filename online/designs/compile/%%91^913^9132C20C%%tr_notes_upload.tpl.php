<?php /* Smarty version 2.6.26, created on 2023-05-15 07:24:17
         compiled from tr_notes_upload.tpl */ ?>
...
<br>
 <div class="container-fluid">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="sname" placeholder="Enter Subject Name..">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="topic" placeholder="Enter Topic Name..">
                                            </div>
                                        </div>
                ...
                <select name="sem" class="form-control" id="t13">
