  ...
  <div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
                 ...
                 <li class="dropdown nav-item">
                            ...
                            <ul class="dropdown-menu agile_short_dropdown">
                                <li>
                                    <a href="attendance_subject_select.php?sem={$sem}&&subject={$subject}">Attendance</a>
                                </li>
                                <li>
                                    <a href="tr_std_attendance_view.php?sem={$sem}&&subject={$subject}">Day View</a>
                                </li>

                                <li>
                                    <a href="tr_std_attendance_view_month.php?sem={$sem}&&subject={$subject}">Month View</a>
                                </li>

                                 <li>
                                    <a href="tr_std_attendance_view_sem.php?sem={$sem}&&subject={$subject}">Sem View</a>
                                </li>
                ...
                <div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
                    ...
                    <!--     <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="timetable_view_tr.php?sem={$sem}">Timetable</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="tr_std_chat.php?sem={$sem}">Chat</a>
                        </li>

                         <li class="nav-item">
                            <a class="nav-link" href="tr_std_class.php?sem={$sem}">Class</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="tr_report.php?sem={$sem}">Report</a>
                        </li>
