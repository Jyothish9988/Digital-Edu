...
{foreach from=$data item="j"}
            ...
            <div class="item">
              <img src="uploads/{$j.akey}/{$j.img1}" alt="Course One" height="200px" width="200px">
              <div class="down-content">
                <h4>{$j.course}</h4>
                <h3>{$j.details}</h3>
                <div class="info">
                  <div class="row">
                    ...
                    <div class="col-4">
                      {if $j.addon!=$j.akey}
                       <span><a href="addon_enroll.php?key={$j.akey}&&sem={$sem}" class="btn btn-primary">Enroll</a></span>
                       {else}
