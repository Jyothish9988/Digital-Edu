...
<table>
  {foreach from=$data item="j"}
        ...
        <!-- adno,name,photo,address,pin,dob,sex,religion,caste,fname,fjob,fpno,mname,mjob,mpno,course,spno,aadhar,dep,ten,tencer,plustwo,plustwocer,doj,grad,email -->
				...
				<tr><td>Teacher"s Id</td><td><input type="text" name="trid" id="t0" class="form-control" value="{$j.trid}"></td></tr>
				...
				<tr><td>Address</td><td><input type="text" name="address" class="form-control" id="t3" value="{$j.address}"></td></tr>
				<tr><td>Pin</td><td><input type="text" name="pin" class="form-control" id="t4" value="{$j.pin}"></td></tr>
				<tr><td>DOB</td><td><input type="date" name="dob"  class="form-control" id="t5" value="{$j.dob}"></td></tr>
          <tr><td>DOJ</td><td><input type="date" name="doj"  class="form-control" id="t11" value="{$j.doj}"></td></tr>
          ...
          <option>Select gender</option>
				...
				<tr><td>Qualification</td><td><input type="text" name="quan" class="form-control" id="t7" value="{$j.quan}"></td></tr>
				<tr><td>Contact</td><td><input type="text" name="tpno" class="form-control" id="t8" value="{$j.tpno}"></td></tr>
				<tr><td>Aadhar No</td><td><input type="text" name="adharno" class="form-control" id="t9" value="{$j.adharno}"></td></tr>
				<tr><td>Photo</td><td><input type="file" name="photo" id="t10" class="form-control" value="{$j.name}"></td></tr>
