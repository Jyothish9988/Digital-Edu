...
<tr>
	<td>Heading</td>
	<td><input type="text" name="heading" id="t1" class="form-control" value={$j.heading}></td>
	
</tr>
<tr>
	<td>Subject</td>
	
	<td><textarea name="subject"  class="form-control" id="t2" height="100%" >{$j.subject}</textarea></td>
</tr>
<tr>
	<td>Photo</td>
	<td><img src="uploads/{$j.gkey}/{$j.img1}" heigh="150px" width="150px"></td>
	<td><input type="file" name="photo" id="t3" class="form-control" value="{$j.img1}"></td>
</tr>
<tr>
	<td><input type="submit" value="Update" onClick="return ver()" class="btn btn-primary"></td>
</tr>
	{/foreach}		
</table>
