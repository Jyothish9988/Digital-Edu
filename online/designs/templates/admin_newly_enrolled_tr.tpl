                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                ...
                                <tr>
                                       ...
                                       <td align="center"><a href="tr_edit.php?tr_key={$j.tr_key}&&sem={$j.sem}" class="btn btn-outline-danger">Edit</a></td> 
                
                                        <td align="center"><a href="tr_delete.php?tr_key={$j.tr_key}&&sem={$j.sem}" class="btn btn-outline-danger">Delete</a></td> 
