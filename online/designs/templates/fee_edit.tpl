 ...
 <div class="container-fluid">
            ...
            {foreach from=$data item="j"}    
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="fees" value="{$j.fees}" placeholder="Enter Fee Amount..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select type="text" name="sem" id="t1" class="form-control" placeholder="Enter Sem" value="{$j.sem}">
