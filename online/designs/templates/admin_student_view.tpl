                        ...
                        <div class="card">
                            ...
                            <div style="overflow-x:auto">
                                ...
                                <tr>
                                        ...
                                        <td><a href="std_reject.php?std_key={$j.lkey}&&sem={$j.sem}" class="btn btn-danger">Reject</a></td>
                                        {elseif $j.astus=='1'}
                                        <td><a href="std_approve.php?std_key={$j.lkey}&&sem={$j.sem}" class="btn btn-success">Approve</a></td>
