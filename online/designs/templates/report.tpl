                           ...
                           <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{$j.report}</td>
                                    <td>{$j.reply}</td>
                                    <td><a href="tr_report_edit.php?rkey={$j.rkey}&&sem={$sem}" class="btn btn-success">Edit</a></td>
                                    <td><a href="tr_report_delete.php?rkey={$j.rkey}&&sem={$sem}" class="btn btn-outline-danger">Delete</a></td>
